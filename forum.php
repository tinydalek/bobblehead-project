        ...
        <div class="container-fluid">
            <div class="row content">
                ...
                <div id="custom_form" class="col-sm-12 col-md-12 col-lg-7 container">
		            ...
		            <ul>
                        <li><a href="add_forum_post.php">Add a Post</a></li>
		            </ul>
...
//Get the topics
$get_topics_sql = "SELECT topic_id, topic_title, topic_description, DATE_FORMAT(topic_create_time, '%b %e %Y at %r') AS
...
$topic_description = stripslashes($topic_info['topic_description']);
...
$display_block .= <<<END_OF_TEXT
<tr>
<td><a href="show_forum_topic.php?topic_id=$topic_id">
<strong>$topic_title</strong><br/>
$topic_description</a><br/>
